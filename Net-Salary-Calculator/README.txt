...
This is a simple web application for calculating net salary from the input gross salary based on NSSF, NHIF and PAYE deductions. It is designed for employed Kenyan taxpayers who receive a monthly salary.
...
Click the "Submit" button to calculate the deductions, total deductions and net salary.
